...
base_container = dict(
    ...
    guard=False,
    resources=dict(
        cpu=dict(max=300, min=75, guard=True),
...
if __name__ == "__main__":
    ...
    containers = [("node0", "host35"), ("node1", "host35"), ("node2", "host35"), ("node3", "host35"),
                  ("node4", "host36"), ("node5", "host36"), ("node6", "host36"), ("node7", "host36"),
                  ("node8", "host37"), ("node9", "host37"), ("node10", "host37"), ("node11", "host37"),
                  ("node12", "host38"), ("node13", "host38"), ("node14", "host38"), ("node15", "host38")]
    hosts = ["host35", "host36", "host37", "host38"]
