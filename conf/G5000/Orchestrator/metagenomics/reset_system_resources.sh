...
export LXD_SCRIPT_PATH=$RESCALER_PATH/conf/G5000/NodeRescaler/metagenomics
export COUCHDB_SCRIPT_PATH=$RESCALER_PATH/conf/G5000/StateDatabase/metagenomics
