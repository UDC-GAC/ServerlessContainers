...
export LXD_SCRIPT_PATH=$RESCALER_PATH/conf/G5000/NodeRescaler/testing_single
export COUCHDB_SCRIPT_PATH=$RESCALER_PATH/conf/G5000/StateDatabase/testing_single
