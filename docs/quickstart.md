...
```
bash scripts/services/start_database_snapshoter.sh
bash scripts/services/start_structure_snapshoter.sh
```
...
```
bash scripts/services/start_guardian.sh
bash scripts/Orchestrator/Guardian/activate_guardian.sh
bash scripts/services/start_scaler.sh
```
